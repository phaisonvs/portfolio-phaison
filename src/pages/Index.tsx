        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-12">
            <ScrollAnimator className="w-full md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Precisa de um documento impresso?</h2>
              <div className="mt-4">
                <ActionButton 
                  onClick={handleDownload} 
                  isPending={isDownloading}
                  variant="outline"
                  className="flex items-center gap-2 group border-white/20 text-white hover:bg-white/10 dark:hover:border-white/30"
                >
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <ScrollAnimator>
            <div className="mb-12 flex items-center gap-4">
              <div className="p-3 rounded-lg bg-gray-100/10 dark:bg-navy-800/30 backdrop-blur-sm relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <ScrollAnimator key={testimonial.id} delay={index * 150} className="h-full">
                <div className="h-full flex flex-col p-6 rounded-lg border border-white/10 dark:border-navy-700/50 bg-white/10 dark:bg-navy-800/30 backdrop-blur-md shadow-sm hover:shadow-md transition-all relative">
                  <div className="mb-6">
                  ...
                  <p className="text-gray-200 dark:text-gray-300 italic mb-6 flex-grow">{testimonial.quote}</p>
                  ...
                  <div className="flex items-center mt-auto">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-300 dark:text-gray-400">{testimonial.position}, {testimonial.company}</p>
                    </div>
                  </div>
                </div>
              </ScrollAnimator>
      ...
      <section id="contact" className="py-16 bg-gray-50 dark:bg-navy-900/30 relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <ScrollAnimator>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Vamos conversar sobre seu projeto?</h2>
            ...
            <ScrollAnimator delay={150}>
              <div className="flex justify-center gap-6 mb-10">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 rounded-full border border-white/20 hover:bg-white/10 dark:hover:bg-navy-700 transition-all text-white"
                  aria-label="GitHub"
                >
            ...
            <ScrollAnimator delay={300}>
              <a 
                href="mailto:example@example.com"
                className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-600 dark:hover:bg-blue-700 font-medium transition-colors relative overflow-hidden group btn-press"
              >
