            ...
            <CarouselContent className="-ml-4">
              {visibleProjects.map((project, index) => (
                <CarouselItem
                  ...
                  className="pl-4 basis-full md:basis-1/2 lg:basis-1/3" // Adicionado basis-full para telas pequenas
                >
                  {/* Usando ProjectCard existente se ele já tiver a estrutura desejada */}
                  {/* Se não, manter a estrutura Card abaixo */}
                  <Card className="h-full flex flex-col bg-gray-900/40 dark:bg-gray-900/40 border border-gray-700/30 dark:border-gray-700/30 rounded-xl backdrop-blur-sm shadow-lg hover:border-emerald-800/40 dark:hover:border-emerald-800/40 transition-all">
