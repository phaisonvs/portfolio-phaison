...
export function FeaturedProjectsCarousel({
  ...
  // Calcula o deslocamento para o transform
  const cardWidthPercentage = 100 / visibleCards;
  // Assumindo que cada card tem um padding horizontal total de 1rem (px-2 em ambos os lados = 8px * 2 = 16px = 1rem)
  // A lacuna entre os cards é controlada pelo padding, então não adicionamos explicitamente
  const translateXValue = useMemo(() => {
    // Calcula a largura percentual de um único card
    const singleCardWidthPercent = 100 / visibleCards;
    // Calcula o deslocamento baseado no índice atual
    return -currentIndex * singleCardWidthPercent;
  ...
  }, [maxIndex]); // Atualiza dependência para maxIndex
  ...
  return (
    <div className="space-y-8 w-full overflow-hidden">
      ...
      {/* Nossa própria implementação de carrossel */}
      <div
      ...
      >
        <div className="relative w-full max-w-full">
          ...
          >
            {/* Container dos slides com transição suave e transform */}
            <div
            ...
            >
              {projects.map((project, index) => (
                ...
                >
                  <motion.div className="group relative overflow-hidden rounded-xl h-full flex flex-col bg-gray-900/40 backdrop-blur-sm border border-gray-800/30 hover:border-emerald-800/40 transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-2 rounded-full bg-gray-800/50 backdrop-blur-sm text-gray-300 hover:bg-gray-700/70 disabled:opacity-50 disabled:cursor-not-allowed transition-all border border-gray-700/30"
