...
export function ProjectsShowcase({ projects }: ProjectsShowcaseProps) {
  ...
  // Configuração de animação para mobile
  const slideVariants = {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      {/* Mobile Projects Slider (Visível apenas em telas pequenas) */}
      <div className="block sm:hidden mt-8">
        <div className="relative w-full max-w-[320px] min-w-[280px] mx-auto">
          ...
          {/* Dots e Botões para Mobile abaixo dos dots */}
              ...
              {projects.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-colors duration-200 ${
                    index === mobileIndex ? "bg-emerald-400" : "bg-gray-600"
                  }`}
                  onClick={() => {
