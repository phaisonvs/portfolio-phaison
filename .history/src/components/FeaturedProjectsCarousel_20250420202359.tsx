...
export function FeaturedProjectsCarousel({
  ...
  return (
    <div className="space-y-8 w-full max-w-full overflow-x-hidden">
      ...
      {/* Carrossel com Container Contendo Overflow-X */}
      <div className="w-full max-w-full px-0 sm:px-0 lg:px-0 overflow-x-hidden">
        <div className="relative w-full max-w-full">
          {/* Carrossel com largura rigorosamente controlada */}
          <div
            ref={carouselRef}
          ...
          >
            {/* Trilha de animação com transformação */}
            <div
            ...
            >
              {/* Cards com largura controlada pelo número visível */}
              {projects.map((project, index) => (
                <div
                  key={project.id}
                  className="shrink-0 grow-0 basis-auto px-2"
                  style={{
