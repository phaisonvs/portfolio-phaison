                    ...
                    <div key={item.name}>
                      {item.isAnchor ? (
                        <button
                          ...
                          className={cn(
                            "text-base font-light px-3 py-2 rounded-md transition-colors w-full text-left tracking-wider",
                            item.highlight
                        ...
                        <Link
                          to={item.href}
                          className={cn(
                            "text-base font-light px-3 py-2 rounded-md transition-colors block tracking-wider",
                            item.highlight
                              ? "bg-emerald-700 hover:bg-emerald-600 text-white relative overflow-hidden glow-button-animation"
            ...
            {navItems.map((item, i) => (
              ...
              >
                {item.highlight ? (
                  ...
                  <Link
                    to={item.href}
                    className={`text-base font-light transition-colors tracking-wider relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-[1px] after:bottom-0 after:left-0 after:bg-emerald-500 after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left ${
                      location.pathname === item.href ||
                      (item.href !== "/" &&
                        location.pathname.startsWith(item.href))
