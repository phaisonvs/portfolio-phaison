...
export function ProjectsShowcase({ projects }: ProjectsShowcaseProps) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      {/* Mobile Projects Slider (Reintroduzido com lógica corrigida) */}
      <div className="block sm:hidden mt-8">
        <div className="relative w-full max-w-[320px] min-w-[280px] mx-auto overflow-hidden rounded-xl">
          <motion.div className="relative h-full" style={{ height: "auto" }}>
            <motion.div
              key={mobileIndex}
              custom={direction}
              ...
              onDragEnd={(event, { offset, velocity }) => {
                ...
                if (swipePower < -swipeThreshold) {
                  ...
                  // Opcional: Animar de volta se o swipe for fraco (requer mais lógica)
                }
              }}
              className="group absolute top-0 left-0 w-full h-full overflow-hidden rounded-xl flex flex-col bg-gray-900/40 backdrop-blur-sm border border-gray-800/30 transition-colors duration-300 hover:border-emerald-800/40"
            >
