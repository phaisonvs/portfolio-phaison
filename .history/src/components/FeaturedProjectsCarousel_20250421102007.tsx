...
export function FeaturedProjectsCarousel({
  ...
  useEffect(() => {
    ...
    // Removida dependência de currentIndex para evitar recalculos desnecessários
  ...
  return (
    <div className="w-full max-w-full">
      ...
      {/* Carousel container - Corrigido para garantir overflow hidden */}
      <div
        ref={carouselRef}
      ...
      >
        ...
        <ReactSpring.animated.div
          className="flex"
          style={{
            width: "100%", // Define largura fixa de 100%
            transform: x.to((val) => `translateX(${val}%)`), // Usa transform com translateX em vez de estilo x
          }}
        >
          {projects.map((project, index) => (
            ...
            <div
              key={project.id}
              className="pr-4 sm:pr-6" // Espaçamento entre cards
              style={{
                width: `${100 / visibleCards}%`, // Largura relativa ao número de cards visíveis
                flexShrink: 0, // Previne que os cards encolham
              }}
            >
              {/* Conteúdo do Card */}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 px-4 sm:px-0">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={projects.length <= visibleCards || currentIndex === 0}
          >
            <svg
          ...
          <button
            ...
            disabled={
              projects.length <= visibleCards || currentIndex === numPages - 1
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
