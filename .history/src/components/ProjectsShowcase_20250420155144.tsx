      ...
      <div className="hidden sm:block relative">
        <div className="overflow-hidden" ref={sliderRef}>
          <motion.div
            ...
            style={{
              width: `${(projects.length / visibleItems) * 100}%`,
            }}
          >
        ...
        <div className="flex items-center justify-end mt-6 gap-3">
          <div className="flex-1 flex items-center">
            <div className="hidden sm:flex justify-start gap-1.5">
              {projects.map((_, index) => (
                <button
                  key={index}
                  className={`w-2 h-2 rounded-full transition-colors ${
                    Math.floor(currentIndex / visibleItems) ===
                    Math.floor(index / visibleItems)
                  ...
                  onClick={() => {
                    ...
                    setCurrentIndex(
                      Math.floor(index / visibleItems) * visibleItems
                    );
                  }}
                  aria-label={`Ir para grupo de projetos ${
                    Math.floor(index / visibleItems) + 1
                  }`}
                />
              ))}
            </div>
          ...
          <button
            onClick={prevProject}
            className="bg-gray-800/70 backdrop-blur-sm p-2.5 rounded-full text-white hover:bg-gray-700/70 transition-colors border border-gray-700/30"
        ...
        <div className="relative w-full max-w-[320px] min-w-[280px] mx-auto">
          ...
          <div className="mt-5 flex flex-col items-center gap-3">
            ...
            <div className="flex gap-3 mt-1">
              <button
                onClick={prevProject}
                className="bg-gray-800/70 backdrop-blur-sm p-2 rounded-full text-white hover:bg-gray-700/70 transition-colors border border-gray-700/30"
                aria-label="Projeto anterior"
              >
