      ...
      <div className="responsive-swiper-container">
        <Swiper
          ...
          breakpoints={{
            ...
            320: {
              slidesPerView: 1.2,
              spaceBetween: 15, // Mantido para telas menores
            },
            // Exibe 3 slides a partir de 640px com mais espaço
            640: {
              slidesPerView: 3,
              spaceBetween: 30, // Aumentado de 20 para 30
              coverflowEffect: {
                rotate: 5,
                stretch: 0,
                depth: 80, // Reduzido ligeiramente
                modifier: 1,
                slideShadows: false,
              },
            },
            // Ajuste para telas maiores (>= 1024px)
            1024: {
              slidesPerView: 3,
              spaceBetween: 40, // Aumentado ainda mais para telas largas
              coverflowEffect: {
                rotate: 4,
                stretch: 0,
                depth: 70, // Reduzido ainda mais
                modifier: 1,
                slideShadows: false,
              },
            },
