  ...
  return (
    <div className="space-y-8">
      ...
      <Carousel
        ...
        className="w-full"
      >
        {/* Restaurar ml negativo padrão */}
        <CarouselContent className="-ml-4">
          {projects.map((project) => (
            <CarouselItem
              key={project.id}
              // Usar px-2 para padding consistente em todos os tamanhos
              className="min-w-0 basis-full sm:basis-1/2 lg:basis-1/3 px-2"
            >
              {/* Card Content permanece o mesmo */}
              <motion.div
