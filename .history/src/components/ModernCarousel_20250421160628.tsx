    ...
    <div className="modern-carousel-section">
      ...
      <div className="modern-swiper-container">
        <Swiper
          ...
          spaceBetween={24} // Espaço entre slides
          slidesPerView={"auto"} // Deixa o CSS controlar a largura dos slides
          centeredSlides={false} // Alinha slides à esquerda por padrão
          loop={false} // Desativado para evitar problemas de largura
          autoplay={{
            delay: 4000,
          ...
          pagination={{
            clickable: true,
            el: ".modern-swiper-pagination", // Usar container customizado
          }}
          navigation={{
          ...
          watchOverflow={true} // Ajuda a gerenciar overflow
          breakpoints={{
            // Em telas maiores, podemos centralizar e talvez mostrar mais
            768: {
              spaceBetween: 32,
              // centeredSlides: true, // Opcional: centralizar em telas maiores
            },
            1024: {
              spaceBetween: 40,
              // centeredSlides: true,
        ...
        {/* Navegação Customizada fora do Swiper */}
