...
export function ProjectsShowcase({ projects }: ProjectsShowcaseProps) {
  ...
  // Funções básicas para Desktop (Embla)
  ...
  // Sistema simplificado para Mobile
  const [mobileIndex, setMobileIndex] = useState(0);

  // Funções básicas para Mobile
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      {/* Mobile Projects Slider (Versão ULTRA simplificada sem animações) */}
      <div className="block sm:hidden mt-8">
        {/* Container principal mobile */}
        <div className="relative w-full max-w-[320px] min-w-[280px] mx-auto">
          <div className="overflow-hidden rounded-xl">
            {/* Card com navegação básica */}
            <div className="group relative w-full overflow-hidden rounded-xl flex flex-col bg-gray-900/40 backdrop-blur-sm border border-gray-800/30 transition-colors duration-300 hover:border-emerald-800/40">
