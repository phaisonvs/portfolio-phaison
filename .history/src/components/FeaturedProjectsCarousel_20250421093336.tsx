...
export function FeaturedProjectsCarousel({
  ...
  // Calcula quantos projetos mostrar baseado no visibleCards
  const visibleProjects = projects.slice(
    currentIndex,
    currentIndex + visibleCards
  );

  // Variantes de animação para o container de slides
  const slideVariants = {
  ...
  return (
    <div className="space-y-8 w-full overflow-hidden">
      ...
      {/* Implementação de carrossel com framer-motion */}
      <div
      ...
      >
        <div className="relative w-full max-w-full">
          ...
          >
            {/* Container dos slides com AnimatePresence para controlar as transições */}
            ...
            <div className="flex items-center gap-1">
              {Array.from({ length: totalPages }).map((_, index) => (
                <button
                  ...
                  onClick={() => {
                    setDirection(index * visibleCards > currentIndex ? 1 : -1);
