...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const speed = 0.5; // Aumentado para efeito mais rápido
      targetOffset = scrollY * speed;
    };

    const animate = () => {
      // Suaviza o movimento com easing
      currentOffset += (targetOffset - currentOffset) * 0.1;
      backgroundImage.style.transform = `translate3d(0, ${currentOffset}px, 0)`;

      // Continua a animação mesmo após parar o scroll
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <motion.section
        className="hero-section pt-28 md:pt-36 pb-16 md:pb-24 relative overflow-hidden bg-gray-50 dark:bg-gray-900/30"
        variants={heroVariants}
        initial="hidden"
        animate="visible"
      >
        {/* Camada de imagem com opacidade e parallax */}
        <div
          className="background-image absolute inset-0"
          style={{
            backgroundImage: 'url("/src/img/hero-background.avif")',
