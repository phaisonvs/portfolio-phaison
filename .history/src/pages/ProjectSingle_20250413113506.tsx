          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <ScrollAnimator>
              <div className="flex flex-col justify-center h-full">
                ...
                <p className="text-gray-300 text-lg mb-8">
                  Tire suas dúvidas sobre este projeto e como podemos adaptar
                  soluções semelhantes para o seu negócio.
                </p>
                <div>
                  <Link
                    to="/#contact"
                    className="inline-flex items-center px-6 py-3 rounded-md bg-emerald-700 hover:bg-emerald-600 transition-colors"
                  >
                    Fale comigo
            ...
            <ScrollAnimator delay={200}>
              <div className="space-y-4">
                {[
                  {
                    question: "Qual foi o prazo de entrega deste projeto?",
                    answer:
                      "O prazo de entrega deste projeto foi de 8 semanas, incluindo as fases de planejamento, design, desenvolvimento e testes. Conseguimos entregar dentro do cronograma estabelecido.",
                  },
                  {
                    question:
                      "É possível adaptar esta solução para outros setores?",
                    answer:
                      "Sim, a arquitetura foi desenvolvida de forma modular e flexível, permitindo adaptações para diferentes indústrias e casos de uso com ajustes específicos conforme necessário.",
                  },
                  {
                    question: "Quais foram os principais desafios técnicos?",
                    answer:
                      "Os principais desafios incluíram a otimização de performance em dispositivos móveis, integração com sistemas legados e implementação de medidas de segurança robustas para proteção de dados sensíveis.",
                  },
                  {
                    question: "Como foi medido o sucesso do projeto?",
                    answer:
                      "O sucesso foi medido através de KPIs específicos, incluindo taxa de conversão, tempo de permanência dos usuários, número de novos clientes e feedback direto dos usuários finais.",
                  },
                ].map((faq, index) => (
                  <div key={index} className="mb-4">
                    <details className="group">
                      <summary className="flex items-center justify-between p-5 rounded-lg bg-gray-800 text-white cursor-pointer hover:bg-gray-750 transition-all">
                      ...
                      <div className="p-5 pt-4 mt-1 rounded-b-lg bg-gray-800/70 -mt-1 text-gray-300">
                        <p>{faq.answer}</p>
                      </div>
                    </details>
                  </div>
