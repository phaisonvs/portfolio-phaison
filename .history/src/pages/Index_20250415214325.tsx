...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Velocidade mais lenta para efeito mais sutil
      const speed = 0.15;
      const offset = scrollY * speed;
      // Movimento inverso (para cima) para efeito mais natural
      backgroundImage.style.transform = `translate3d(0, ${-offset}px, 0) scale(1.1)`;
    };
