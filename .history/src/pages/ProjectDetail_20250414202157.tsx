...
const ProjectDetail = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen flex flex-col bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950"
    >
      <Navbar />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
                <AnimatedCard>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    O principal desafio deste projeto foi criar uma solução
                    digital inovadora que atendesse às necessidades específicas
                    do cliente, proporcionando uma experiência de usuário
                    excepcional e eficiência operacional.
                  </p>
                </AnimatedCard>
                ...
                <AnimatedCard index={1}>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Desenvolvemos uma plataforma completa com interface
                    intuitiva e recursos avançados, focada em desempenho e
                    escalabilidade. Cada elemento foi cuidadosamente projetado
                ...
                {[
                  {
                    ...
                    description:
                      "Interface limpa e fácil de usar, focada em proporcionar a melhor experiência para usuários finais.",
                  },
                  {
                    title: "Alto Desempenho",
                    description:
                      "Otimizado para carregamento rápido e resposta imediata a interações do usuário.",
                  },
                  {
                    title: "Responsividade Total",
                    description:
                      "Adaptado para qualquer dispositivo, desde smartphones até monitores de alta resolução.",
                  },
                  {
                    title: "Integração API",
                    description:
                      "Conexão perfeita com sistemas existentes através de APIs bem estruturadas.",
                  },
                  {
                    title: "Segurança Avançada",
                    description:
                      "Implementação de práticas de segurança de ponta para proteção de dados.",
                  },
                  {
                    title: "Escalabilidade",
                    description:
                      "Arquitetura projetada para crescer conforme a demanda aumenta.",
                  },
                ].map((feature, index) => (
          ...
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
                Se você gostou deste projeto e quer criar algo incrível, entre
                em contato comigo.
              </p>
              <Link
                to="/#contact"
