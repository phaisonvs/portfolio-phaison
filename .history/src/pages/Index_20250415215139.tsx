...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const config = {
      ...
      scaleRange: 0.8, // Quanto a escala pode aumentar/diminuir
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      {/* Background principal fixo para toda a página */}
      <div className="fixed inset-0 w-full h-full z-0">
        ...
        <div
          ...
          style={{
            ...
            opacity: 0.15,
            filter: "contrast(1.1) brightness(0.4) blur(1px)",
          }}
        ></div>

        {/* Gradiente de fundo global para melhorar contraste */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to bottom, rgba(3,7,18,0.9) 0%, rgba(3,7,18,0.98) 100%)",
            zIndex: 1,
          }}
        ></div>

        {/* Efeito de tiles global com opacidade muito baixa */}
        <div className="absolute inset-0 z-2 opacity-5">
          <div className="tiles-container">
            <Tiles rows={60} cols={20} tileSize="lg" className="h-full" />
      ...
      {/* Hero Section - mantém seu parallax próprio */}
      <motion.section
        ...
        animate="visible"
      >
        {/* Camada de imagem com parallax e zoom - específica da seção hero */}
        <div
        ...
        {/* Mantém os tiles específicos da hero section com maior opacidade */}
      ...
      <section className="py-24 relative z-10">
        <div className="container px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: <FileText className="h-10 w-10 mb-5 text-emerald-400" />,
              ...
              {
                icon: (
                  <PlayCircle className="h-10 w-10 mb-5 text-emerald-400" />
                ),
              ...
              {
                icon: (
                  <CreditCard className="h-10 w-10 mb-5 text-emerald-400" />
                ),
                title: "E-commerce",
                description:
              ...
              <ScrollAnimator key={index} delay={index * 100}>
                <div className="flex flex-col h-full p-8 rounded-xl backdrop-blur-sm border border-gray-700/30 bg-gray-900/30 hover:bg-gray-800/40 hover:border-emerald-900/40 transition-all">
                  {service.icon}
        ...
        <div className="container px-6 max-w-7xl mx-auto">
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20">
            <ScrollAnimator className="w-full md:w-1/2">
              <div className="aspect-video backdrop-blur-sm border border-gray-700/30 bg-gray-900/30 rounded-2xl shadow-lg overflow-hidden">
                <img
      ...
      {/* Experience Section */}
      <section id="experience" className="py-16 relative z-10 overflow-hidden">
        <div className="container px-6 md:px-6 relative z-10">
          <ScrollAnimator>
            <div className="mb-12 flex items-center gap-4">
              <div className="p-3 rounded-lg bg-gray-800/50 backdrop-blur-sm relative bounce-animation">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <div className="space-y-12">
            {experiences.map((experience, index) => (
              <ScrollAnimator key={experience.id} delay={index * 150}>
                <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-gray-700">
                  <div className="absolute left-0 top-1 w-px h-full">
                    <div className="absolute left-0 top-1 w-2 h-2 -ml-1 rounded-full bg-emerald-500"></div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {experience.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="text-xs px-2 py-1 bg-gray-800/50 backdrop-blur-sm rounded-full text-gray-300"
                        >
                          {tech}
                        </span>
                      ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <ScrollAnimator
                ...
                className="h-full"
              >
                <div className="h-full flex flex-col p-8 rounded-xl backdrop-blur-sm border border-gray-700/30 bg-gray-900/30 hover:bg-gray-800/40 shadow-sm hover:shadow-md transition-all relative">
                  <div className="mb-6">
                    <svg
                      width="48"
                      height="48"
                  ...
                  <div className="flex items-center mt-auto">
                    <img
                      ...
                      className="w-12 h-12 rounded-full mr-4 object-cover border-2 border-emerald-900/30"
                    />
