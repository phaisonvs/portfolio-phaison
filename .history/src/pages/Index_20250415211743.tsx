...
const Index = () => {
  ...
  // Ref para o efeito parallax
  const parallaxRef = useParallax(0.15, 50); // Velocidade sutil para parallax e limite de 50px de movimento
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <motion.section
        ...
        animate="visible"
      >
        {/* Camada de imagem com opacidade e efeito parallax */}
        <div
          ref={parallaxRef}
