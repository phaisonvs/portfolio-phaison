...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col page-wrapper relative">
      ...
      {/* Nova Seção Projetos em Destaque - Usando SimpleCarousel */}
      <section className="py-12 md:py-20 overflow-hidden">
        {/* Container ajustado para controlar padding */}
        <div
          className="container mx-auto px-0 sm:px-6" /* Remover padding horizontal em mobile, pois o Swiper controla */
          style={{ maxWidth: "1150px" }}
        >
          <SimpleCarousel items={featuredProjects} />
        </div>
      </section>
