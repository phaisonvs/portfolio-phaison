...
const Index = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col page-wrapper relative overflow-x-hidden"
      style={{
        transform: "scale(0.9)",
    ...
    >
            ...
            <div className="flex flex-col">
              ...
              >
                <TypeAnimationEnhanced
                  ...
                  repeat={1}
                  cursor={true}
                  className="text-[34px] md:text-[46px] lg:text-[58px] font-medium text-balance leading-tight break-words text-white"
                />
              </motion.div>
      ...
      {/* Seção Projetos em Destaque - Nova Implementação */}
      <section className="w-full py-12 md:py-20 relative overflow-hidden">
        ...
        {/* Background tiles com opacidade reduzida */}
        <div className="absolute inset-0 z-0 opacity-5">
          <div className="tiles-container">
            <Tiles rows={20} cols={10} tileSize="md" className="h-full" />
            <div className="tiles-overlay"></div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-6 max-w-7xl mx-auto">
          <ScrollAnimator>
            <div className="text-center mb-16">
              <h2 className="text-[28px] md:text-[34px] font-medium mb-4 tracking-tight">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20">
            ...
            <ScrollAnimator className="w-full md:w-1/2" delay={200}>
              <div className="space-y-6">
                <h2 className="text-[28px] md:text-[34px] font-medium tracking-tight text-white">
        ...
        <div className="container px-6 md:px-6 relative z-10">
          <ScrollAnimator>
            <div className="mb-12 flex items-center gap-4">
              ...
              <h2 className="text-[22px] font-bold text-white">Experiência</h2>
            </div>
          </ScrollAnimator>
