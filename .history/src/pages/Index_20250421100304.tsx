  ...
  return (
    <div className="min-h-screen flex flex-col page-wrapper relative">
      ...
      >
        ...
        <div className="container max-w-[1150px] mx-auto px-6 md:px-6 relative z-10">
      ...
      {/* Seção Projetos em Destaque - Usando FeaturedProjectsCarousel */}
      <section className="w-full max-w-full py-12 md:py-20 relative overflow-hidden">
        <div className="relative z-10 w-full max-w-full">
          <div className="container max-w-[1150px] mx-auto px-0 sm:px-4 md:px-6 overflow-hidden">
      ...
      <section className="py-24 relative">
        <div className="container max-w-[1150px] mx-auto px-6">
          <ScrollAnimator>
