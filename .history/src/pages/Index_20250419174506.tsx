  ...
  return (
    <div className="min-h-screen flex flex-col page-wrapper relative">
      ...
      <section className="py-24 relative">
        ...
        <div className="container px-6 max-w-7xl mx-auto mb-16">
          <ScrollAnimator>
            <h2 className="text-3xl md:text-4xl font-medium mb-4 tracking-tight text-center">
                  ...
                  >
                    <div className="p-1 h-full">
                      <ProjectCard
                        ...
                        tags={project.tags}
                        index={index}
                        className="h-full" // Garante que o card ocupe a altura total
                      />
                    </div>
                  </CarouselItem>
                ))}
