...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lemni-theme">
      ...
      {/* Contact Section */}
      <section id="contact" className="lemni-section">
        <div className="lemni-container">
          <div className="max-w-3xl mx-auto">
            <ScrollFadeIn direction="up" className="text-center mb-16">
              <h2 className="mb-6">Vamos trabalhar juntos?</h2>
              <p className="max-w-2xl mx-auto mb-12">
                Entre em contato para conversarmos sobre o seu projeto e como
              ...
              <div className="flex justify-center gap-6 mb-12">
                <a
                  ...
                  className="p-3 rounded-full border border-border hover:bg-stone-100 dark:hover:bg-gray-900 transition-all"
                  aria-label="GitHub"
                >
              ...
              <a
                href="mailto:contato@miltonivan.com"
                className="lemni-button lemni-button-primary text-lg px-8 py-4"
              >
                Enviar Email
