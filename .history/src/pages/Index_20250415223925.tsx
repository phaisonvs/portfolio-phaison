...
const Index = () => {
  ...
  // Efeito Parallax com Zoom (sem bounce)
  useEffect(() => {
    ...
    // Definir as configurações do efeito com valores mais sutis (sem bounce)
    const config = {
      baseScale: 1.05, // Escala base da imagem
      scaleRange: 0.03, // Quanto a escala pode aumentar/diminuir
      maxScroll: 2000, // Ponto máximo de scroll para efeito completo
      verticalSpeed: 0.05, // Velocidade do movimento vertical
    };
    ...
    const handleScroll = () => {
      ...
      // Calcular a escala com base apenas no progresso do scroll (sem bounce)
      const zoomFactor =
        config.baseScale +
        ...
        <div className="container px-6 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-900/40 backdrop-blur-sm rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-700/30">
              ...
              <a
                href="mailto:contato@phaisonpholio.dev"
