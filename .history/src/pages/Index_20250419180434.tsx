  ...
  return (
    <div className="min-h-screen flex flex-col page-wrapper relative">
      ...
      <div className="fixed inset-0 z-[-2] overflow-hidden">
        ...
        {/* Background animado Squares */}
        <Squares
          direction="diagonal"
          speed={0.3} // Velocidade um pouco mais lenta
          squareSize={35} // Tamanho um pouco menor
          borderColor="rgba(16, 185, 129, 0.1)" // Cor da borda com alfa (esmeralda sutil)
          hoverFillColor="rgba(16, 185, 129, 0.08)" // Cor do hover com alfa
          className="absolute inset-0 z-[-1] opacity-20" // Posicionado acima do fundo, abaixo do conteúdo, com 20% de opacidade
        />
