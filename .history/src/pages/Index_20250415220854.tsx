...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const config = {
      ...
      bounceTime: 4, // Tempo em segundos para um ciclo completo de bounce
    ...
    function applyBounceEffect() {
      ...
      const bounceValue = Math.sin(
        (currentTime * (Math.PI * 2)) / config.bounceTime
      ); // Cálculo do bounce
      return bounceValue * 30; // Aumente a amplitude para 30px, por exemplo
    }
